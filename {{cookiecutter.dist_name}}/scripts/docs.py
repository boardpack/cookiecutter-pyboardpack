"""Lightweight version of docs.py script for {{ cookiecutter.project_name }} package

You can find original here: https://github.com/tiangolo/fastapi/blob/master/scripts/docs.py
...
def build_lang(
    ...
    # Exclude first 2 entries {{ cookiecutter.project_name }} and Languages, for custom handling
    use_nav = nav[2:]
